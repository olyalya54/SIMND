    ...
    <div class="page" id="page">
        ...
        <main class="main">
            <div class="container">
                ...
                <form class="form  form--auth" action="signin.php" method="post">
                    ...
                    <div class="form__group  form__group--md">
                        <input name="password" class="form__control" type="password" placeholder="Пароль">
                        <span class="form__line"></span>
                    </div>
                
                    <div class="form__footer  form__footer--center">
                        <div class="form__group  form__group--md">
                            <button type="submit" name="button-log" class="btn  btn--blue  btn--rounded  btn--sm">Войти</button>
                        </div>
