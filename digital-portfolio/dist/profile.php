                    ...
                    <div class="cabinet">
                        <div class="cabinet__form">
                            <div class="form__group  form__group--md">
                                <input name = "login" value = "<?=$login?>" class="form__control" type="text" placeholder="Ваше имя">
                            ...
                            <div class="form__group  form__group--md">
                                <input name = "pass-first" class="form__control" type="password" placeholder="Новый пароль">
                                <span class="form__line"></span>
                            </div>
                        ...
                        <div class="cabinet__avatar">
                            ...
                            <form action="/" method="post" enctype="multipart/form-data" class="cabinet__file">
